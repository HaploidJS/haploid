...
export const __HAPLOID_GLOBAL_EXPORT_RESOLVER__ = '__HAPLOID_GLOBAL_EXPORT_RESOLVER__';
export const __HAPLOID_DOWNLOADER__ = '__HAPLOID_DOWNLOADER__';
export const __HAPLOID_DEV_TOOL__ = '__HAPLOID_DEV_TOOL__';

// global map
export const __HAPLOID_GLOBAL_MAP_GLOBAL_EXPORTED__ = '__HAPLOID_GLOBAL_MAP_GLOBAL_EXPORTED__';
...
export const HAPLOID_GLOBAL_EXPORT_RESOLVER_VERSION = 0x301;
